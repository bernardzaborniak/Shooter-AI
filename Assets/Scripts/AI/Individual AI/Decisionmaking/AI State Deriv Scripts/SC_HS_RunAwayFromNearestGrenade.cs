...
namespace BenitosAI
{
    [CreateAssetMenu(menuName = "AI/States/Run Away From Nearest Grenade", fileName = "Run Away From Nearest Grenade")]


    public class SC_HS_RunAwayFromNearestGrenade : AIStateCreator
    {
        ...
        {
            St_HS_RunAwayFromNearestGrenade state = new St_HS_RunAwayFromNearestGrenade(aiController, context);
            return state;
        }
    }

    public class St_HS_RunAwayFromNearestGrenade : AIState
    {
        ...
        public St_HS_RunAwayFromNearestGrenade(AIController aiController, DecisionContext context)
        {
